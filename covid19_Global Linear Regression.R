...
par(mfrow=c(2, 3))
#USA
plot(density(confirmed$US), main="Confirmed : Density Plot: US", ylab="Frequency",
     sub=paste("Skewness:", round(e1071::skewness(confirmed$US), 2))) 
polygon(density(confirmed$US), col="red")

#CHINA
plot(density(confirmed$China), main="Confirmed : Density Plot: China",
     ylab="Frequency", sub=paste("Skewness:", round(e1071::skewness(confirmed$China), 2))) 
polygon(density(confirmed$China), col="red")

#ITALY
plot(density(confirmed$Italy), main="Confirmed : Density Plot: Italy", ylab="Frequency",
     sub=paste("Skewness:", round(e1071::skewness(confirmed$Italy), 2))) 
polygon(density(confirmed$Italy), col="red")

#FRANCE
plot(density(confirmed$France), main="Confirmed : Density Plot: France",
     ylab="Frequency", sub=paste("Skewness:", round(e1071::skewness(confirmed$France), 2))) 
...
confirmed_ts <- ts(runif(confirmed[,2:ncol(confirmed)]
                         , 1, ncol(confirmed[,2:ncol(confirmed)])), frequency=10)
